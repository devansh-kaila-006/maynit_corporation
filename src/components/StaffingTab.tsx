          ...
          return (
            <div
              ...
              className={`rounded-3xl border p-6 text-left cursor-pointer transition-all flex flex-col justify-between hover:scale-[1.01] ${
                isSelected
                  ? 'bg-gradient-to-br from-blue-50/90 to-indigo-50/40 border-blue-200 text-slate-850 shadow-md'
                  : 'bg-white border-slate-100 text-slate-700 hover:border-slate-300 hover:bg-slate-50 shadow-sm'
              }`}
            >
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 flex justify-between items-center text-xs">
                <span className={isSelected ? 'text-slate-500' : 'text-slate-500'}>
                  Explore details
                </span>
                <ArrowRight className={`h-4 w-4 ${isSelected ? 'text-blue-600' : 'text-slate-400'}`} />
              </div>
            </div>
          );
        })}
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 md:p-8 shadow-sm text-left grid grid-cols-1 lg:grid-cols-12 gap-8" id="staffing-detail-showcase">
        ...
        <div className="lg:col-span-5 rounded-3xl bg-slate-50 p-6 border border-slate-200 flex flex-col justify-between">
          ...
          <button
            ...
            className="mt-6 w-full rounded-xl bg-blue-600 py-3 text-xs font-semibold text-white hover:bg-blue-700 transition-all shadow-sm"
          >
            ...
            <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className={`py-2 px-2 text-[10px] font-semibold rounded-xl border transition-all ${
